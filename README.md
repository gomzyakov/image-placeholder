...
<img scr="tests/images/example_1.png" alt="Image placeholder generated with PHP (example one)" class="width: 200px;">

<img scr="tests/images/example_2.png" alt="Image placeholder generated with PHP (example two)" class="width: 200px;">

<img scr="tests/images/example_3.png" alt="Image placeholder generated with PHP (example three)" class="width: 200px;">
